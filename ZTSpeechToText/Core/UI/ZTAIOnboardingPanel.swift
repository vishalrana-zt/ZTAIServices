...
private enum ZTAIOnboardingStrings {
    ...
    static var outputDisclaimer: String { localized("lbl_ai_onboarding_output_disclaimer", fallback: "AI can make mistakes, please use your own judgement before using") }
}
